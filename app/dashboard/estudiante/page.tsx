...
import { mockUsuarios, getEstudianteInfracciones, getRetrasoCount, mockEstudiantes } from "@/lib/mock-data"
...
export default function EstudianteDashboard() {
  ...
  // Obtener el estudiante vinculado a este usuario
          ...
          <div className="space-y-3">
            {infracciones.map((inf) => {
              ...
              return (
                <div
                  key={inf.id}
                  className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex flex-col sm:flex-row sm:items-start gap-3"
                >
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {inf.descripcion && (
                      <p className="text-gray-600 text-sm">{inf.descripcion}</p>
                    )}
